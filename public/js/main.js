...
socket.on('join_room_response',function(payload){
    ...
    /* if we have seen the person who just joined (sth. wired happend) */
    else {
...
socket.on('game_update',function(payload){
    ...
    if(socket.id == payload.game.player_white.socket){
        ...
        /* Sth/ weird is going on, like three people playing at once */
        ...
        if(board[row][column] == 'w'){
          ...
          if(old_board[row][column] != board [row][column]){
              if(old_board[row][column] == '?' && board[row][column] == ' '){
                ...
                else if(old_board[row][colume] == '?' && board[row][column] == 'w'){
                  $('#'+row+'_'+column).html('<img src="assets/images/empty to white.gif" alt="white square"/>');
                }
                else if(old_board[row][colume] == '?' && board[row][column] == 'b'){
        ...
        if(board[row][column] == ' '){
          ...
          $('#'+row+'_'+column).click(function(r,c){
              return function(){
                  ...
                  console.log('*** client Log Messsage: \'play_token\' payload: '+JSON.stringify(payload));
